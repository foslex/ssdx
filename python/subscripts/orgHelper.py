...
def InstallWorkDotComPermissionSet(term):
	...
	return helper.tryCommand(term, ["sfdx force:source:deploy -p force-app\main\default\permissionsets\Workplace_Command_Center_Standard_PermSet_Admin_Full_Access_Cloned.permissionset-meta.xml"], True, True, False)
